...
<template>
  <div>
    ...
    <div class="min-h-screen bg-gray-100">
      <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('daily-tasks.index')" :active="route().current('daily-tasks.index')">
                  ToDo List
                </NavLink>
              </div>
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
        ...
        <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            ...
            <ResponsiveNavLink :href="route('daily-tasks.index')" :active="route().current('daily-tasks.index')">
              ToDo List
            </ResponsiveNavLink>
            ...
            <ResponsiveNavLink :href="route('currencies.index')" :active="route().current('currencies.index')">
              Currencies
            </ResponsiveNavLink>
            <ResponsiveNavLink :href="route('paymentTypes.index')" :active="route().current('paymentTypes.index')">
              Payment Types
            </ResponsiveNavLink>
      ...
      <div v-else-if="$page.props.flash.message"
        class="bg-green-100 border border-green-400 text-green-700 px-3 py-1 rounded relative text-center  mt-2"
        role="alert">
        <span class="block sm:inline">{{ $page.props.flash.message }}</span>
        <span class="absolute top-0 bottom-0 right-0 px-3 py-3 hidden">
